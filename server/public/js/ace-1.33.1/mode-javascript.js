define(
  ...
  function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      index = e('./text_highlight_rules').TextHighlightRules,
      s = function () {
        (this.$rules = {
          start: [
            {
  ...
  define(
    ...
    function (e, t, n) {
          ...
          t = {
            onMatch: function (e, t, n) {
              ...
              return [
                ...
                { type: 'meta.tag.tag-name.xml', value: e.slice(r) }
              ];
            },
            regex: '</?(?:' + e + '|(?=>))',
            next: 'jsxAttributes',
      ...
      var r = e('../lib/oop'),
        index = e('./jsdoc_comment_highlight_rules').JsDocCommentHighlightRules,
        ...
        u = function (e) {
          ...
          this.$rules = {
            no_regex: [
              index.getStartRule('doc-start'),
              f('no_regex'),
              { token: 'string', regex: "'(?=.)", next: 'qstring' },
              { token: 'string', regex: '"(?=.)', next: 'qqstring' },
              {
                token: 'constant.numeric',
                regex: /0(?:[Xx][\dA-Fa-f]+|[Oo][0-7]+|[Bb][01]+)\b/
              },
              {
                token: 'constant.numeric',
                regex: /(?:\d+(?:\.\d*)?|\.\d+)(?:[Ee][+-]?\d+\b)?/
            ...
            property: [
              ...
              },
              {
                ...
                regex:
                  /(s(?:ystemLanguage|cr(?:ipts|ollbars|een(?:X|Y|Top|Left))|t(?:yle(?:Sheets)?|atus(?:Text|bar)?)|ibling(?:Below|Above)|ource|uffixes|e(?:curity(?:Policy)?|l(?:ection|f)))|h(?:istory|ost(?:name)?|as(?:h|Focus))|y|X(?:MLDocument|SLDocument)|n(?:ext|ame(?:space(?:s|URI)|Prop))|M(?:IN_VALUE|AX_VALUE)|c(?:haracterSet|o(?:n(?:structor|trollers)|okieEnabled|lorDepth|mp(?:onents|lete))|urrent|puClass|l(?:i(?:p(?:boardData)?|entInformation)|osed|asses)|alle[er]|rypto)|t(?:o(?:olbar|p)|ext(?:Transform|Indent|Decoration|Align)|ags)|SQRT(?:1_2|2)|i(?:n(?:ner(?:Height|Width)|put)|ds|gnoreCase)|zIndex|o(?:scpu|n(?:readystatechange|Line)|uter(?:Height|Width)|p(?:sProfile|ener)|ffscreenBuffering)|NEGATIVE_INFINITY|d(?:i(?:splay|alog(?:Height|Top|Width|Left|Arguments)|rectories)|e(?:scription|fault(?:Status|Ch(?:ecked|arset)|View)))|u(?:ser(?:Profile|Language|Agent)|n(?:iqueID|defined)|pdateInterval)|_content|p(?:ixelDepth|ort|ersonalbar|kcs11|l(?:ugins|atform)|a(?:thname|dding(?:Right|Bottom|Top|Left)|rent(?:Window|Layer)?|ge(?:X(?:Offset)?|Y(?:Offset)?))|r(?:o(?:to(?:col|type)|duct(?:Sub)?|mpter)|e(?:vious|fix)))|e(?:n(?:coding|abledPlugin)|x(?:ternal|pando)|mbeds)|v(?:isibility|endor(?:Sub)?|Linkcolor)|URLUnencoded|P(?:I|OSITIVE_INFINITY)|f(?:ilename|o(?:nt(?:Size|Family|Weight)|rmName)|rame(?:s|Element)|gColor)|E|whiteSpace|l(?:i(?:stStyleType|n(?:eHeight|kColor))|o(?:ca(?:tion(?:bar)?|lName)|wsrc)|e(?:ngth|ft(?:Context)?)|a(?:st(?:M(?:odified|atch)|Index|Paren)|yer[Xs]|nguage))|a(?:pp(?:MinorVersion|Name|Co(?:deName|re)|Version)|vail(?:Height|Top|Width|Left)|ll|r(?:ity|guments)|Linkcolor|bove)|r(?:ight(?:Context)?|e(?:sponse(?:XML|Text)|adyState))|global|x|m(?:imeTypes|ultiline|enubar|argin(?:Right|Bottom|Top|Left))|L(?:N(?:10|2)|OG(?:10E|2E))|b(?:o(?:ttom|rder(?:Width|RightWidth|BottomWidth|Style|Color|TopWidth|LeftWidth))|ufferDepth|elow|ackground(?:Color|Image)))\b/
              },
            ...
            this.$rules.no_regex.unshift(
              {
                ...
                onMatch: function (e, t, n) {
                  ...
                  if (e == '{' && n.length > 0) n.unshift('start', t);
                  else if (e == '}' && n.length > 0) {
                    n.shift(), (this.next = n.shift());
                    if (
                      this.next.includes('string') ||
                      this.next.includes('jsx')
                    )
          ...
          this.embedRules(index, 'doc-', [index.getEndRule('no_regex')]),
            this.normalizeRules();
        };
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../../lib/oop'),
        index = e('../behaviour').Behaviour,
        s = e('../../token_iterator').TokenIterator,
        u = function () {
          this.add(
            'string_dquotes',
            'insertion',
            function (e, t, n, r, index_) {
              if (index_ == '"' || index_ == "'") {
                var u = index_,
            ...
            this.add(
              ...
              'deletion',
              function (e, t, n, r, index_) {
                var s = r.doc.getTextRange(index_);
                if (!index_.isMultiLine() && (s == '"' || s == "'")) {
                  var o = r.doc.getLine(index_.start.row),
                    u = o.substring(
                      index_.start.column + 1,
                      index_.start.column + 2
                    );
                  if (u == s) return index_.end.column++, index_;
                }
              }
            ),
            this.add('autoclosing', 'insertion', function (e, t, n, r, index_) {
              if (index_ == '>') {
                ...
                var d = f.value;
                h == u.row && (d = d.slice(0, Math.max(0, u.column - p)));
                if (
                  this.voidElements &&
            ...
            this.add('autoindent', 'insertion', function (e, t, n, r, index_) {
              if (index_ == '\n') {
                var u = n.getCursorPosition(),
                  a = r.getLine(u.row),
                  f = new s(r, u.row, u.column),
                  l = f.getCurrentToken();
                if (o(l, '') && l.type.includes('tag-close')) {
                  if (l.value == '/>') return;
                  while (l && !l.type.includes('tag-name'))
                    l = f.stepBackward();
                  if (!l) return;
                  var c = l.value,
                    h = f.getCurrentTokenRow();
                  l = f.stepBackward();
                  if (!l || l.type.includes('end-tag')) return;
                  if (
      ...
      r.inherits(u, index), (t.XmlBehaviour = u);
    }
  ),
  define(
    ...
    function (e, t, n) {
      'use strict';
      var r = e('../../lib/oop'),
        index = e('../../token_iterator').TokenIterator,
      ...
      (function () {
        (this.getFoldWidget = function (e, t, n) {
          ...
          (this._getFirstTagInLine = function (e, t) {
            var n = e.getTokens(t),
              r = new u();
            for (var index_ = 0; index_ < n.length; index_++) {
              var s = n[index_];
              if (a(s, 'tag-open')) {
                ...
                for (index_++; index_ < n.length; index_++) {
                  (s = n[index_]), (r.end.column += s.value.length);
                  if (a(s, 'tag-close')) {
          ...
          (this._findEndTagInLine = function (e, t, n, r) {
            var index_ = e.getTokens(t),
              s = 0;
            for (var o = 0; o < index_.length; o++) {
              var u = index_[o];
              s += u.value.length;
              if (s < r - 1) continue;
              if (a(u, 'end-tag-open')) {
                (u = index_[o + 1]),
                  a(u, 'tag-name') && u.value === '' && (u = index_[o + 2]);
          ...
          (this.foldingStartMarker = /([([{])[^)\]}]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              if (
                ...
                return '';
              var index_ = this._getFoldWidgetBase(e, t, n);
              return !index_ && this.startRegionRe.test(r) ? 'start' : index_;
            }),
            (this.getFoldWidgetRange = function (e, t, n, r) {
              var index_ = e.getLine(n);
              if (this.startRegionRe.test(index_))
                return this.getCommentRegionBlock(e, index_, n);
              var s = index_.match(this.foldingStartMarker);
              if (s) {
                var o = s.index;
              ...
              var s = index_.match(this.foldingStopMarker);
              if (s) {
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new index(s, o, u, e.getLine(u).length);
            }),
            (this.getCommentRegionBlock = function (e, t, n) {
              ...
              var l = n;
              if (l > o) return new index(o, r, l, t.length);
            });
        }.call(o.prototype);
    }
  ),
      ...
      r.inherits(o, s),
        function () {
          (this.getFoldWidgetRangeBase = this.getFoldWidgetRange),
            ...
            (this.getFoldWidgetRange = function (e, t, n, r) {
              var index = this.getFoldWidgetRangeBase(e, t, n, r);
              return index
                ? index
          ...
          (this.lineCommentStart = '//'),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              var r = this.$getIndent(t),
                index = this.getTokenizer().getLineTokens(t, e),
                s = index.tokens,
                o = index.state;
              if (s.length > 0 && s.at(-1).type == 'comment') return r;
